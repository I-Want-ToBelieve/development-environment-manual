...
<center>![](images/JDK-DOWNLOADPAGE.png)</center>>
...
<center>![](images/ProgramFile.png)</center>>    
<center>![](images/JavaJDKFilePath.png)</center>>
这是Java解压后所在的目录,就以当前目录为例。

### 配置环境
打开这台电脑,然后点击属性
<center>![](images/Win10.png)</center>>
...
<center>![](images/Win10OSAttr.png)</center>>
变量值就是JDK所在路径
然后配置另外一个环境变量名
    <center>![](images/JAVA_HOMEPATHVAR.png)</center>>
再将配置好的`JAVA_HOME`添加到系统环境变量下,系统环境变量变量名为`Path`，在找到变量名为`Path`的变量后，点击进去,然后再点击新建,输入你定义好的环境变量名`JAVA_HOME`和百分号，如下
<center>![](images/系统变量.png)</center>
...
<center>![](images/JavaVersion.png)</center>>
